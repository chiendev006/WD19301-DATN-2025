    			...
    			<div class="col-md-6">
    				<div class="row">
    					<div class="col-md-6">
                            ...
                            <a href="#" class="img" style="background-image: url('{{ asset('assetsclient/images/menu-1.jpg') }}');"></a>

		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
                            <a href="#" class="img" style="background-image: url('{{ asset('assetsclient/images/menu-2.jpg') }}');"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry">
                            <a href="#" class="img" style="background-image: url('{{ asset('assetsclient/images/menu-3.jpg') }}');"></a>
		    				</div>
    					</div>
    					<div class="col-md-6">
    						<div class="menu-entry mt-lg-4">
                            <a href="#" class="img" style="background-image: url('{{ asset('assetsclient/images/menu-4.jpg') }}');"></a>
		    				</div>
    					</div>
    				</div>
    			</div>
